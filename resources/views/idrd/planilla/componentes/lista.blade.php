@section('script')
	...
	<script data-recargable="true" src="{{ asset('public/Js/planillas/componentes/componentes.js') }}"></script>
@stop
<div id="main_list" class="row" data-url="{{ url('componentes') }}">
	<div class="col-xs-12">
		<h4>{{ $titulo }}</h4>
	</div>
		...
		<form action="" id="main_form">
			<div class="modal-content">
				<div class="modal-header">
	    			...
	    			<h4 class="modal-title" id="myModalLabel">Crear, editar o eliminar una componente.</h4>
	  			</div>
	      		<div class="modal-body">
		      		<fieldset>
		        		...
		        		<div id="mensaje_no_eliminar" class="col-xs-12 oculto">
		        			<small class="text-info">No se puede eliminar un componente con contratos asignados.</small>
		        		</div>
		      		</fieldset>
		      	</div>
