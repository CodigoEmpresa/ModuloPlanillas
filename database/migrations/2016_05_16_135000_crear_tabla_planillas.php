...
class CrearTablaPlanillas extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('PlanillasRecursos', function($table)
        {
            ...
            $table->integer('UVT')->unsigned()->nullable();
            ...
            $table->integer('Base_UVR_Ley_1607')->unsigned()->nullable();
            $table->integer('Base_UVR_Art_384')->unsigned()->nullable();
            ...
            $table->integer('Declarante')->unsigned()->nullable();
